...
class ErrorHandlerTest {
    ...
    @Test
    fun `getError should return Unauthorized for 401`() =
        runTest {
    ...
    @Test
    fun `getError should return RequestTimeout for 408`() =
        runTest {
    ...
    @Test
    fun `getError should return Conflict for 409`() =
        runTest {
    ...
    @Test
    fun `getError should return PayloadTooLarge for 413`() =
        runTest {
    ...
    @Test
    fun `getError should return ClientError for status 404`() =
        runTest {
    ...
    @Test
    fun `getError should return ServerError for status 500`() =
        runTest {
    ...
    @Test
    fun `getError should return UnknownError for unknown status`() =
        runTest {
