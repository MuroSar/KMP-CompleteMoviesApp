...
class MovieDetailViewModelTest {
    ...
    @Test
    fun `fetchMovieDetail should return information when all use cases return Success`() =
        runTest {
    ...
    @Test
    fun `fetchMovieDetail should return information when use cases return Success and there are no collection`() =
        runTest {
            val recommendedMovies = listOf<Movie>()
    ...
    @Test
    fun `fetchMovieDetail should return Error when all use cases return the same error`() =
        runTest {
    ...
    @Test
    fun `fetchMovieDetail should return Error when getMovieDetailByIdUseCase return error`() =
        runTest {
            val recommendedMovies = listOf<Movie>()
    ...
    companion object {
        ...
        private val movieDetailWithoutCollection =
            MovieDetail(
                id = 9292,
                adult = false,
                backdropPath = "indoctum",
